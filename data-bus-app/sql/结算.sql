...
-- mls_statement_log -暂时不处理
-- mls_statement_carrier 暂时不处理
-- mls_statement_carrier_detail 暂时不处理

-- mls_statement_platform_provider 不处理
-- mls_statement_platform_provider_detail 不处理
